...
BeatPicker.prototype = {
	...
	daysFull: [],
	monthsSimple: "一月 二月 三月 四月 五月 六月 七月 八月 九月 十月 十一 十二".split(" "),
	...
	selectDate: function(a) {
		if (!isNaN(Date.parse(a)) && (a = this.cr(a) ? a : new Date(Date.parse(a)), this.ax(a, null, !0), this.c && this.c.length))
			for (var b in this.c)
				if (this.ch(this.c[b].data("date"),
